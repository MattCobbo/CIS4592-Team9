        ...
        <VStack alignItems="start" w="100%" gap="40px">
            ...
            <HStack gap="20px">
                ...
                <VStack gap="20px">
                    ...
                    {loading ? <Spacer /> : isOwner ? <Button w="100%">Edit Profile</Button> : (
                        <Button onClick={handleToggleFollow} w="100%" colorScheme="blue">
...
const UserPosts = ({ posts, loading }) => {
    return (
        <Flex direction="column" gap="30px" pb="60px">
            {loading ? <Text>Loading...</Text> : posts.length > 0 ? (
                posts.map((post) => (
